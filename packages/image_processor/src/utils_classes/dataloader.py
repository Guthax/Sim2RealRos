...
class DTSegmentationDataset(torch.utils.data.Dataset):
    ...
    CVAT_XML_FILENAME = "annotations.xml"
    SEGM_LABELS = {
        'Background': {'id': 0, 'rgb_value': [0, 0, 0]}, # black
        'Ego Lane': {'id': 1, 'rgb_value': [128, 64, 128]}, # green
        'Opposite Lane': {'id': 2, 'rgb_value': [128,64,128]}, # orange
        'Obstacle': {'id': 3, 'rgb_value': [0,0,0]}, # purple
        'Road End': {'id': 4, 'rgb_value': [0,0,0]}, # red
        'Intersection': {'id': 5, 'rgb_value': [128, 64, 128]}, # blue
        'Middle Lane': {'id': 6, 'rgb_value': [157,234, 50]}, # yellow
        'Side Lane': {'id': 7, 'rgb_value': [0,0,0]}, # white
    }
    def __init__(self):
